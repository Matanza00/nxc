    ...
    <section className="overflow-x-hidden">
      <div
        className="
          ...
          // BASE
          pl-36 py-2 pr-12 container mx-auto flex flex-row xl:flex-col items-center bg-slate-200/60 text-slate-900 overflow-x-hidden overflow-y-hidden
      ...
      >
        ...
        >
          <h1
            ...
            // BASE
            mb-5 text-4xl font-semibold font-['Courgette']
            ...
            "
          >
            We're Gapping The Bridge To Your Dreams into Reality.
          </h1>
          <h2
            className="
            
            // BASE
            leading-relaxed font-['Courgette'] overflow-hidden text-xl 
