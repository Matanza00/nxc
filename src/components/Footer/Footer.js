...
import Credit from '../Credits Link/Credits';
import nxc from '../../assets/nxc_logo_white.png';

function Footer() {
  return (
    <>
      <footer className="relative z-10 bg-white pt-10 pb-0 lg:pt-[120px] lg:pb-20 bg-slate-900/95 text-slate-50 ">
        <div className="container">
            <div className="flex flex-wrap pl-40 gap-10 grid grid-cols-4 sm:grid-cols-1 overflow-x-hidden 
            // BASE
            pl-40 pr-12
            ...
            iPhone8Plus:pl-12
            ">
            <div className="w-full px-1 sm:p-0 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base mb-7 text-body-color">
                  Welcome to NXC Sol, where your digital goals find a fitting solution. 
                  With a deep understanding of how technology can be overwhelming, 
                  we’ve made it our mission to simplify the complex for you.
                </p>
                
              </div>
            </div>

            <LinkGroup header="Our Resources">
              <NavLink link="/#" label="Web Design" />
              <NavLink link="/#" label="Web Application" />
              <NavLink link="/#" label="Mobile Design" />
              <NavLink link="/#" label="Mobile Application" />
              <NavLink link="/#" label="3d Game Development" />
              <NavLink link="/#" label="Graphic Designing" />
              <NavLink link="/#" label="Rigging & Animation" />
            </LinkGroup>
            
            <LinkGroup header="Quick Links">
              <NavLink link="/#" label="Our Services" />
              <NavLink link="/#" label="About NXC Sol" />
              <NavLink link="/#" label="Contact & Support" />
              <NavLink link="/#" label="Pricing & Packages" />
              <NavLink link="/#" label="Gallery & Portfolio" />
            </LinkGroup>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color font-bold">
                  {" "}
                  info@nxcsol.com
                </p>
                <p className="text-base text-body-color font-bold">
        ...
        <div className="flex items-center justify-center">
            <p className="font-[Poppins] font-bold hover:text-sky-500">© 2023 NXC Solutions. All Rights Reserved </p>
        </div>
      </footer>
    </>
  );
