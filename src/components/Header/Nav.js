...
function Nav() {
  ...
  const LeftMenu = [
    ...
    { title: 'Portfolio', src: navImg3, pathway: '/gallery' },
    //{ title: 'Pricing and Packages', src: navImg3, pathway: '/gallery' },
  ...
  const BottomMenu = [
    ...
    { title: 'NXC Sol', src: navImg13, pathway: '/credit' },
  ];
  ...
  return (
    <header className="overflow-x-visible">
      ...
      <nav className="flex z-50 ">
        ...
        // ALL SIZES
        z-40 shadow-lg shadow-black overflow-hidden opacity-90
          ...
          <a href={`/`}>
            <div className="nav-list flex gap-x-4 items-center overflow-hidden">
              <img
                ...
                src={process.env.PUBLIC_URL + '/logonxc.png'}
                alt="nav logo"
              ></img>
              <h1
                className={`
