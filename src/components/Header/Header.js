...
import header1 from '../../assets/nxc_logo_white.png';
...
function Header() {
  ...
  return (
    <section className="text-gray-600 body-font overflow-x-hidden home-header-section bg-slate-900/95 text-slate-50">
      <div
        className="
     ...
     // 1161px | almosttherelg
      ...
      >
        ...
        // Base
          flex-grow w-1/2 pl-40 pr-70 flex flex-col items-center text-center 
        ...
        "
        >
          <h1 className="title-font sm:text-4xl text-6xl mb-4 font-semibold text-slate-200 w-full xl:text-4xl lg:text-5xl lg:w-full font-['Inter']">
            Welcome to
          </h1>
          <img
            className="object-cover object-center rounded shadow-2xl sm pb-16"
            alt="hero"
            src={header1}
          ></img>
          <h2 className="title-font sm:text-4xl text-3xl mb-4  drop-shadow-md text-sky-300/95 w-full xl:text-2xl lg:text-5xl lg:w-full font-['Courgette'] italic">
            Surging you with Services and Success
          </h2>

          <p className="mb-8 leading-relaxed font-['Poppins'] overflow-hidden text-slate-200">
          Crafting
          digital ecosystems that breathe life into 
          brands and transform businesses.   
            Creating
          ...
          >
            ...
            >
              <button className="inline-flex opacity-90 text-white bg-galleryButton border-0 py-2 px-6 focus:outline-none hover:bg-sky-300/80 rounded text-lg ">
                Book 20 Minutes Complentary Consultation
              </button>
            </a>
          </div>
        </div>
